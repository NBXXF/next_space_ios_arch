...
-(NSString *)call:(NSString*) method :(NSString*) argStr
{
    ...
    if(!JavascriptInterfaceObject){
        ...
        method=nameStr[1];
        NSString *methodOne = [JSBUtil methodByNameArg:1 selName:method clazz:[JavascriptInterfaceObject class]];
        NSString *methodTwo = [JSBUtil methodByNameArg:2 selName:method clazz:[JavascriptInterfaceObject class]];
...
- (bool) hasNativeMethod:(NSDictionary *) args
{
    ...
    if(JavascriptInterfaceObject){
        bool syn=[JSBUtil methodByNameArg:1 selName:nameStr[1] clazz:[JavascriptInterfaceObject class]]!=nil;
        bool asyn=[JSBUtil methodByNameArg:2 selName:nameStr[1] clazz:[JavascriptInterfaceObject class]]!=nil;
