...
@objc public enum DismissSwipeDirection:Int {
    case `default`
    case bottom
    case top
}
...
@objc public enum BackgroundTapAction:Int {
	case noAction
	case dismiss
	case passthrough
}
...
@objcMembers open class Presentr: NSObject {
	...
	@objc public var backgroundTap: BackgroundTapAction = .dismiss
