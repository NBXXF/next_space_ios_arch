...
@interface NXOrderedDictionary<__covariant KeyType, __covariant ObjectType> : NSDictionary<KeyType, ObjectType>
/**
 ...
 */
@interface NXMutableOrderedDictionary<KeyType, ObjectType> : NXOrderedDictionary<KeyType, ObjectType>
