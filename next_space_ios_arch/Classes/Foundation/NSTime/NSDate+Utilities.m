...
- (BOOL)isSameDayAsDate:(NSDate *)aDate{
    ...
    NSDateComponents* components2 = [calendar components:(NSYearCalendarUnit | NSMonthCalendarUnit | NSDayCalendarUnit) fromDate:aDate];
...
- (NSDateComponents *) componentsWithOffsetFromDate: (NSDate *) from
{
	NSDateComponents *dTime = [[NSDate currentCalendar] components:componentFlags fromDate:from toDate:self options:0];
	return dTime;
}
