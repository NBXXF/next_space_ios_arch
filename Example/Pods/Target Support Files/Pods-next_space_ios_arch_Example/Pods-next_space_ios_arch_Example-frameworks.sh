...
if [[ "$CONFIGURATION" == "Debug" ]]; then
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/NXFoundation/NXFoundation.framework"
  install_framework "${BUILT_PRODUCTS_DIR}/NXUIKit/NXUIKit.framework"
  ...
  install_framework "${BUILT_PRODUCTS_DIR}/next_space_ios_arch/next_space_ios_arch.framework"
fi
